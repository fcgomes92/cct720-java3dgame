...
public class Chao {
	...
	private final static Color3f darkGreen = new Color3f(0.0f, 0.6f, 0.1f);
	private final static Color3f medRed = new Color3f(0.0f, 0.4f, 0.3f);
	...
	public Chao(){
		...
		floorBG.addChild(new ColouredTiles(blueCoords, darkGreen));
	...
	private void addOriginMarker(){ // points created counter-clockwise, a bit above the floor
