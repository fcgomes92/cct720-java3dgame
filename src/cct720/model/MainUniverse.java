...
public class MainUniverse{
	...
	private static final Point3d USERPOSN = new Point3d(15, 15, 0);
	private Vector3d posInicialCamera = new Vector3d(0, 10, 0);
	...
	private void createSceneGraph(){
		...
		bounds = new BoundingBox(new Point3d(-BOUNDSIZE, -BOUNDSIZE, -BOUNDSIZE), new Point3d(BOUNDSIZE, BOUNDSIZE, BOUNDSIZE));
